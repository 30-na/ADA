...
# Group means
kang_mean     <- dat_kang %>%                            summarise(m = mean(ml))
kang_mean_x   <- dat_kang %>% group_by(sex)          %>% summarise(m = mean(ml)) %>% ungroup()
kang_mean_s   <- dat_kang %>% group_by(species)      %>% summarise(m = mean(ml)) %>% ungroup()
kang_mean_xs  <- dat_kang %>% group_by(sex, species) %>% summarise(m = mean(ml)) %>% ungroup()
